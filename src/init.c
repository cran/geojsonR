...
extern SEXP geojsonR_export_From_geojson(SEXP, SEXP, SEXP, SEXP);
extern SEXP geojsonR_export_From_geojson_schema(SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"geojsonR_export_From_geojson",        (DL_FUNC) &geojsonR_export_From_geojson,        4},
    {"geojsonR_export_From_geojson_schema", (DL_FUNC) &geojsonR_export_From_geojson_schema, 4},
